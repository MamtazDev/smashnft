      ...
      <div className="col-span-full sm:col-span-6 xl:col-span-3 bg-white shadow-lg rounded-sm border border-slate-200">
        <div className="flex flex-col h-full">
          <div className="grow mb-1">
            ...
            <h3 className="text-lg text-blue-500 font-semibold mb-1 border-b p-5">User Profile</h3>
          </div>
         <h3 className='p-5'>Total: 7</h3>
         <h3 className='pl-5 pb-5'>New users today: 0</h3>
        </div>
      </div>
      <div className="col-span-full sm:col-span-6 xl:col-span-3 bg-white shadow-lg rounded-sm border border-slate-200">
        <div className="flex flex-col h-full">
          <div className="grow mb-1">
            ...
            <h3 className="text-lg text-blue-500 font-semibold mb-1 border-b p-5">Commodity information</h3>
          </div>
         <h3 className='p-5'>The total goods: 13</h3>
         <h3 className='pl-5 pb-5'>Today's new products: 1</h3>
        </div>
      </div>
      <div className="col-span-full sm:col-span-6 xl:col-span-3 bg-white shadow-lg rounded-sm border border-slate-200">
        <div className="flex flex-col h-full">
          <div className="grow mb-1">
            ...
            <h3 className="text-lg text-blue-500 font-semibold mb-1 border-b p-5">Trade information</h3>
          </div>
         <h3 className='p-5'>Total trade: 4</h3>
         <h3 className='pl-5 pb-5'>Today's trading: 0</h3>
        </div>
      </div>
      <div className="col-span-full sm:col-span-6 xl:col-span-3 bg-white shadow-lg rounded-sm border border-slate-200">
        <div className="flex flex-col h-full">
          <div className="grow mb-1">
            ...
            <h3 className="text-lg text-blue-500 font-semibold mb-1 border-b p-5">Selling the information</h3>
          </div>
         <h3 className='p-5'>Is selling: 3</h3>
