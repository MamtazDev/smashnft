        ...
        <div className="relative px-4 sm:px-6 lg:px-8 pb-8 max-w-lg mx-auto">
          <div className="bg-white px-8 pb-6 rounded-b shadow-lg">
            ...
            <div className="text-center mb-6">
              ...
              <h1 className="text-xl leading-snug text-slate-800 font-semibold mb-2">Statistical Distribution 🔥</h1>
...
<div className='flex justify-center gap-6 mt-6'>
    <button className='border p-3 rounded-lg bg-gray-100'>Cancel</button>
    <button className='border p-3 rounded-lg bg-blue-500 text-white'>Determine</button>
</div>
